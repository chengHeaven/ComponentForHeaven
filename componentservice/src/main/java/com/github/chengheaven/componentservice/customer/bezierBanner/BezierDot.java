...
public class BezierDot extends View implements ViewPager.OnPageChangeListener {
    ...
    public BezierDot(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BezierDot(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        color_touch = array.getColor(R.styleable.BezierDot_color_touch, color_touch);
        color_stroke = array.getColor(R.styleable.BezierDot_color_stroke, color_stroke);
        time_animator = array.getInteger(R.styleable.BezierDot_time_animator, time_animator);
        default_round_count = array.getInteger(R.styleable.BezierDot_round_count, default_round_count);
        mRadius = array.getDimensionPixelSize(R.styleable.BezierDot_radius, mRadius);
        array.recycle();
     ...
     */
    public void attachToViewPager(BezierViewPager vPage, ImageView background, List<Object> imageList) {
        ...
        if (CardPagerAdapter.class.isInstance(vPage.getAdapter())) {
            ...
            mWidth = (20 + getInterval()) * default_round_count + mRadius * 2 * default_round_count;
            initCountPos();
        }
    }
...
//                        Log.e(TAG, "ontouch  isAniming" + isAniming);
    ...
    private boolean isTouchAnimating = false;
    ...
    private void startTouchAnimator() {
        ...
        if (animatorTouch != null) {
            ...
            animatorTouch.addUpdateListener(animation -> {
